...
/* harmony import */ var html2canvas__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(309);
/* harmony import */ var html2canvas__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(html2canvas__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var vanilla_picker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(310);
/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
...
var images = {
  sample: __webpack_require__(311)["default"],
  img_border_bg: __webpack_require__(312)["default"],
  img_border_bg_sd: __webpack_require__(313)["default"],
  img_inner_bg: __webpack_require__(314)["default"],
  img_inner_bg_sd: __webpack_require__(315)["default"]
};
var loadedImages = {};
var WIDTH = 850,
    HEIGHT = 300;
...
window.apply = function () {
  draw();
  document.getElementById("nick").innerHTML = document.getElementById("nick_input").value;
  document.getElementById("footer").innerHTML = document.getElementById("footer_input").value;
  document.getElementById("heading").innerHTML = document.getElementById("header_input").value;
  document.getElementById("list").innerHTML = document.getElementById("list_input").value;
};
...
window.init = function () {
  ...
  (function () {
    var parent = document.getElementById("outer_bg_1");
    parent.style.background = color_list.outer_bg[0];
    var picker = new vanilla_picker__WEBPACK_IMPORTED_MODULE_1__["default"]({
      parent: parent,
      color: color_list.outer_bg[0],
      alpha: false
    });

    picker.onChange = function (color) {
      parent.style.background = color.rgbaString;
      color_list.outer_bg[0] = color.rgbaString;
      draw();
    };
  })();
  ...
  (function () {
    var parent = document.getElementById("outer_bg_2");
    console.log(parent);
    parent.style.background = color_list.outer_bg[1];
    var picker = new vanilla_picker__WEBPACK_IMPORTED_MODULE_1__["default"]({
      parent: parent,
      color: color_list.outer_bg[1],
      alpha: false
    });

    picker.onChange = function (color) {
      parent.style.background = color.rgbaString;
      color_list.outer_bg[1] = color.rgbaString;
      draw();
    };
  })();

  (function () {
    var parent = document.getElementById("inner_bg_1");
    parent.style.background = color_list.inner_bg[0];
    var picker = new vanilla_picker__WEBPACK_IMPORTED_MODULE_1__["default"]({
      parent: parent,
      color: color_list.inner_bg[0],
      alpha: false
    });

    picker.onChange = function (color) {
      parent.style.background = color.rgbaString;
      color_list.inner_bg[0] = color.rgbaString;
      draw();
    };
  })();
  ...
  (function () {
    ...
    var picker = new vanilla_picker__WEBPACK_IMPORTED_MODULE_1__["default"]({
      parent: parent,
      color: color_list.inner_bg[1],
      alpha: false
    });

    picker.onChange = function (color) {
      parent.style.background = color.rgbaString;
      color_list.inner_bg[1] = color.rgbaString;
      draw();
    };
  })();
...
function draw() {
  ...
  (function () {
    ...
    if (document.getElementById("outer_bg_2").style.display === 'none') {
      ctx.fillStyle = color_list.outer_bg[0];
    } else {
      var grd = ctx.createLinearGradient(0, 0, 850, 0);
      grd.addColorStop(0, color_list.outer_bg[0]);
      grd.addColorStop(1, color_list.outer_bg[1]);
      ctx.fillStyle = grd;
    }
  ...
  (function () {
    ...
    if (document.getElementById("inner_bg_2").style.display === 'none') {
      ctx.fillStyle = color_list.inner_bg[0];
    } else {
      var grd = ctx.createLinearGradient(0, 0, 850, 0);
      grd.addColorStop(0, color_list.inner_bg[0]);
      grd.addColorStop(1, color_list.inner_bg[1]);
      ctx.fillStyle = grd;
    }
    ...
    ctx.save();
    ctx.globalCompositeOperation = "destination-in";
    ctx.drawImage(loadedImages["img_inner_bg"], 0, 0);
    ctx.restore();
    ctx.drawImage(loadedImages["img_inner_bg_sd"], 0, 0);
  })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("./dist/86bfd7db335232d7216c23ac2c9bdb18.jpg");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("./dist/9b45753a9e60859789c39888a49d53ea.png");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("./dist/aca06489c61d8cfaac4ddee3b55e3092.png");
