...
/* harmony import */ var html2canvas__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
...
var images = {
  sample: __webpack_require__(5)["default"],
  img_border_bg: __webpack_require__(6)["default"],
  img_border_bg_sd: __webpack_require__(7)["default"],
  img_inner_bg: __webpack_require__(8)["default"],
  img_inner_bg_sd: __webpack_require__(9)["default"]
};
var WIDTH = 850,
    HEIGHT = 300;
var loadedImages = {};
...
function resizeImg(img, maxWidth, maxHeight, degrees) {
  ...
  ratio2 = maxHeight / imgHeight; // Use the smallest ratio that the image best fit into the maxWidth x maxHeight box.
  ...
  copyContext.drawImage(img, 0, 0); // init
  ...
  for (var i = 1; i <= rounds; i++) {
    ...
    copyContext.drawImage(canvasCopy2, 0, 0, canvasCopy2.width, canvasCopy2.height, 0, 0, canvasCopy.width, canvasCopy.height); // copy back
  ...
  canvasContext.drawImage(canvasCopy2, -canvasCopy2.width / 2, -canvasCopy2.height / 2); //var dataURL = canvas.toDataURL();
...
window.screenshot = function () {
  html2canvas__WEBPACK_IMPORTED_MODULE_2___default()(document.getElementById('frame'), {
...
function _draw() {
  _draw = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var canvas1, canvas2, canvas;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (function () {
              ...
              ctx.drawImage(resizeImg(loadedImages["sample"], width, height), 490, 10);
              ctx.drawImage(canvas2, 0, 0);
              ctx.drawImage(canvas1, 0, 0);
              ctx.fillStyle = 'white';
              ctx.font = 'bold 24px NanumSquare'; //ctx.fillText('CPU', 23, 40);
            })();
